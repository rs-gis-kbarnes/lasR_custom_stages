...
bool LASRclassifytransfer::process(PointCloud*& las)
{
  ...
  ref_x.reserve(ref_header.number_of_point_records);
  ref_y.reserve(ref_header.number_of_point_records);
  ref_z.reserve(ref_header.number_of_point_records);
  ref_class.reserve(ref_header.number_of_point_records);
